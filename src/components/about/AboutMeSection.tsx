            ...
            <div className='container-x '>
                <div className="md:flex items-center gap-8  md:p-12">
                    <div className="relative ">
                        <Image src={"/images/about-thumb.png"} width={800} height={800} alt="hero thumb" className="h-auto max-w-sm" />
                    ...
                    <div className="space-y-6 max-w-xl pt-4 pb-6">
                        <div className="text-blue-900">
                            <p className="uppercase text-primary font-semibold pb-4">✵ ABOUT US</p>
