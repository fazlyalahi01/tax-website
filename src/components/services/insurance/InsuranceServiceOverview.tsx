...
const InsuranceServiceOverview: React.FC = () => {
    return (
        <div className="bg-lite pt-8 overflow-hidden">
            <div className='container-x '>
                <div className="md:flex items-center gap-8  md:p-12">
                    <div className="relative ">
                        <Image src={"/images/insurance-service-bg.png"} width={800} height={800} alt="hero thumb" className="h-auto max-w-sm" />
                    ...
                    <div className="space-y-6 max-w-xl pt-4 pb-6">
                        <div className="text-blue-900">
                            ...
                            <h1 className="md:text-4xl text-3xl font-extrabold text-title pb-1">Insurance Consultation Service</h1>
...
export default InsuranceServiceOverview;